...
import com.example.uhf.fragment.UHFLoginFragment;
...
public class UHFMainActivity extends BaseTabFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.fragment_container, new UHFLoginFragment()) // R.id.fragment_container là ID của layout container
                .commit();
    }
